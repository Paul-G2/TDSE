...
namespace TdseSolver_3D1P
{
    ...
    public partial class VCodeBuilder : Form
    {
        ...
        /// </summary>
        public float V(float x, float y, float z, float t, float mass, float domainSizeX, float domainSizeY, float domainSizeZ)
        {
            return (float) m_vCalcMethodInfo.Invoke( null, new object[]{x, y, z, t, mass, domainSizeX, domainSizeY, domainSizeZ} );
        }
        ...
        private static string DefaultSnippet
        {
            get
            {
                return
                    ...
                    "/////////////////////////////////////////////////////////////////////////////                                                   \n" +
                    "                                                                                                                                \n" +
                    "public static float V(float x, float y, float z, float t, float mass, float domainSizeX, float domainSizeY, float domainSizeZ)  \n" +
                    "{                                                                                                                               \n" +
                    "    return 0.0f;                                                                                                                \n" +
                    "}                                                                                                                               \n";
            }
        ...
        /// <summary>
        /// Gets a code snippet that implements a sphere potential barrier.
        /// </summary>
