...
namespace TdseSolver_3D1P
{
    ...
    public partial class SolverControl : UserControl
    {
        ...
        static string CreateOutputDir()
        {
            ...
            int index = 0;
            string dir = outputDrive + ":\\" + "WfAnimations3D1P" + "\\" + index.ToString("D4"); 
            while ( Directory.Exists(dir) )
            {
                index++;
                dir = outputDrive + ":\\" + "WfAnimations3D1P" + "\\" + index.ToString("D4"); 
            }
            try
            {
        ...
        void EnableInputs(bool val)
        {
            ...
            InitialPacketCenterZ_NUD.Enabled = val;
            InitialMomentumX_NUD.Enabled = val;
            InitialMomentumY_NUD.Enabled = val;
            InitialMomentumZ_NUD.Enabled = val;
