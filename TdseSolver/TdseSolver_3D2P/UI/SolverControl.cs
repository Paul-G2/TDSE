...
namespace TdseSolver_3D2P
{
    ...
    /// 2-particle, time-dependent Schrodinger equation solver. (3D2P TDSE).
    /// </summary>
    public partial class SolverControl : UserControl
    {
        ...
        private RunParams UpdateUiFromParams(RunParams parms)
        {
            ...
            InitialPacketCenter1z_NUD.Value = (decimal) parms.InitialWavePacketCenter1.Z;
        ...
        static string CreateOutputDir()
        {
            ...
            int index = 0;
            string dir = outputDrive + ":\\" + "WfAnimations3D2P" + "\\" + index.ToString("D4"); 
            while ( Directory.Exists(dir) )
            {
                index++;
                dir = outputDrive + ":\\" + "WfAnimations3D2P" + "\\" + index.ToString("D4"); 
            }
            try
            {
