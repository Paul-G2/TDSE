...
namespace TdseSolver_2D2P_NS
{
    ...
    public partial class SolverControl : UserControl
    {
        ...
        static string CreateOutputDir()
        {
            ...
            int index = 0;
            string dir = outputDrive + ":\\" + "WfAnimations2D2P_NS" + "\\" + index.ToString("D4"); 
            while ( Directory.Exists(dir) )
            {
                index++;
                dir = outputDrive + ":\\" + "WfAnimations2D2P_NS" + "\\" + index.ToString("D4"); 
            }
            try
            {
        ...
        void EnableInputs(bool val)
        {
            ...
            P1x_NUD.Enabled = val;
            P1y_NUD.Enabled = val;
            SHOState_ComboBox.Enabled = val;
            AtomSize_NUD.Enabled = val;
